                        ...
                        <div class="axil-footer-widget">
                            ...
                            <div class="inner">
                                ...
                                <ul class="support-list-item">
                                    <li><a href="mailto:example@domain.com"><i class="fal fa-envelope-open"></i> abonalfitri@gmail.com</a></li>
                                    <li><a href="tel:(+01)850-315-5862"><i class="fal fa-phone-alt"></i> +62 896-6239-0211</a></li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="copyright-left d-flex flex-wrap justify-content-center">
                            <ul class="quick-link">
                                <li>© 2023. All rights reserved by <a target="_blank" href="#">Abon Alfitri</a>.</li>
                            </ul>
                        </div>
                    </div>
                </div>
